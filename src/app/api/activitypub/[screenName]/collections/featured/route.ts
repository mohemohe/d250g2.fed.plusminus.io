...
const body = (baseUrl: string, screenName: string, image: string | null) =>
  JSON.stringify({
    "@context": ["https://www.w3.org/ns/activitystreams"],
    id: `${baseUrl}/api/activitypub/${screenName}/collections/featured`,
    type: "OrderedCollection",
    totalItems: 1,
    orderedItems: [d250g2Note(baseUrl, image)],
  });
